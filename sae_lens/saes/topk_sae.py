...
class TopKTrainingSAE(TrainingSAE[TopKTrainingSAEConfig]):
    """Serial library SAE base for BatchTopK variants and compatibility.

    The training runner constructs MegatronTopKSAE for the topk architecture.
    This class has no tensor-parallel backend.
    """
